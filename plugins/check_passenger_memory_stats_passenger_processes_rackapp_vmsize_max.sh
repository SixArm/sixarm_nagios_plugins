...
# passenger processes rackapp vmsize max.
#
...
# ## Tracking
#
#   * Command: check_passenger_memory_stats_passenger_processes_rackapp_vmsize_max
...
#   * Tracker: a3aa06d60c33643c1c1c285341e53d4b
##
...
print_help() {
    ...
    echo "specifically for Passenger processes RackApp VMSize max."
    echo ""
    exit $STATUS_CODE_UK
}

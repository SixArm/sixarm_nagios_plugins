...
# apache processes apache2 vmsize sum.
#
...
# ## Tracking
#
#   * Command: check_passenger_memory_stats_apache_processes_apache2_vmsize_sum
...
#   * Tracker: cb7d3e41b87d42c539f042c88a15e2c6
##
...
print_help() {
    ...
    echo "specifically for Apache processes apache2 VMSize sum."
    echo ""
    exit $STATUS_CODE_UK
}
...
do_output() {
    output="$passenger_memory_stats_apache_processes_apache2_vmsize_sum passenger memory stats apache processes apache2 vmsize sum"
}

do_perfdata() {
    perfdata="'pms_a_vm_sum'=$passenger_memory_stats_apache_processes_apache2_vmsize_sum"
}

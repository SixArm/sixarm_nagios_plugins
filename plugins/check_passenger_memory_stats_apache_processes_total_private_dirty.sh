...
# apache processes total private dirty.
#
...
# ## Tracking
#
#   * Command: check_passenger_memory_stats_apache_processes_total_private_dirty
...
#   * Tracker: 959d7ed49dc50a06e7d892bcd014b234
##
...
do_output() {
    output="$passenger_memory_stats_apache_processes_total_private_dirty passenger memory stats apache processes total private dirty"
}

do_perfdata() {
    perfdata="'pms_a_dirty'=$passenger_memory_stats_apache_processes_total_private_dirty"
}

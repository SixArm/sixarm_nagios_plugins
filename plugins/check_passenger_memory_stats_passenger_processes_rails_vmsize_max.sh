...
# passenger processes rails vmsize max.
#
...
# ## Tracking
#
#   * Command: 849af75efa800a38bdfc87603a5fdf77
...
#   * Tracker: 7734169104357add1c26e34108d2799f
##
...
print_help() {
    ...
    echo "specifically for Passenger processes rails VMSize max."
    echo ""
    exit $STATUS_CODE_UK
}
